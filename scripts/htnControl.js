...
var pushfunctionR9 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,8);"><td>HTN Control</td><td>' + ounames[selectedou] + '</td><td>Quarterly</td><td>' + quarter + '</td><td>' + value + '</td><td>Success</td></tr>'
        ...
        warning: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,8);"><td>HTN Control</td><td>' + ounames[selectedou] + '</td><td>Quarterly</td><td>' + quarter + '</td><td>' + value + '</td><td>Warning</td></tr>'
            $('.reporttable').append(row);
            totalHTNPatients = 0, totalStage1Patients = 0, totalStage2Patients = 0, totalStage3Patients = 0;
        },
        error: function (response) {
            console.log("ERROR for OU = " + selectedou + " and Period = " + quarter);
            var row = '<tr onclick="displayValues(this,8);"><td>HTN Control</td><td>' + ounames[selectedou] + '</td><td>Quarterly</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
            $('.reporttable').append(row);
            totalHTNPatients = 0, totalStage1Patients = 0, totalStage2Patients = 0, totalStage3Patients = 0;
        }
    });
