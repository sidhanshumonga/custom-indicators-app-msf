...
var pushfunctionR8 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,9);"><td>HTN Medications</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Success</td></tr>'
        ...
        warning: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,9);"><td>HTN Medications</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Warning</td></tr>'
            $('.reporttable').append(row);
            totalPatientsHTN = 0, totalHTNPatients12withBP = 0;
            totalPatients1Medicine = 0, totalPatients2Medicines = 0, totalPatients3MedicinesMore = 0, totalMedications = 0;
            totalHTNPatients12 = 0;
        ...
        error: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,9);"><td>HTN Medications</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
            $('.reporttable').append(row);
            totalPatientsHTN = 0, totalHTNPatients12withBP = 0;
            totalPatients1Medicine = 0, totalPatients2Medicines = 0, totalPatients3MedicinesMore = 0, totalMedications = 0;
            totalHTNPatients12 = 0;
