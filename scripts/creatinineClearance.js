...
var pushfunctionR2 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,3);"><td>Creatinine Clearance</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Success</td></tr>'
        ...
        warning: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,3);"><td>Creatinine Clearance</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Warning</td></tr>'
            $('.reporttable').append(row);
            crtMoreThan90 = 0, crtMoreThan60LessThan90 = 0, crtMoreThan30LessThan60 = 0, crtMoreThan15LessThan30 = 0, crtLessThan15 = 0;
            totalPatientsWithCRT = 0;
        },
        error: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,3);"><td>Creatinine Clearance</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
            $('.reporttable').append(row);
            crtMoreThan90 = 0, crtMoreThan60LessThan90 = 0, crtMoreThan30LessThan60 = 0, crtMoreThan15LessThan30 = 0, crtLessThan15 = 0;
            totalPatientsWithCRT = 0;
        }
