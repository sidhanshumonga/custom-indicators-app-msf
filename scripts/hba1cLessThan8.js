...
var pushfunctionR7 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,7);"><td>Hba1c less than 8 in last 12 months</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Success</td></tr>'
        ...
        warning: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,7);"><td>Hba1c less than 8 in last 12 months</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Warning</td></tr>'
            $('.reporttable').append(row);
            TotalHba1c = 0, TotalHba1cLessThan8 = 0, type1LessThan8 = 0, type1TotalHba1c = 0, type2LessThan8 = 0, type2TotalHba1c = 0;
        },
        error: function (response) {
            console.log("ERROR for OU = " + selectedou + " and Period = " + quarter);
            var row = '<tr onclick="displayValues(this,7);"><td>Hba1c less than 8 in last 12 months</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
            $('.reporttable').append(row);
            TotalHba1c = 0, TotalHba1cLessThan8 = 0, type1LessThan8 = 0, type1TotalHba1c = 0, type2LessThan8 = 0, type2TotalHba1c = 0;
        }
    });
