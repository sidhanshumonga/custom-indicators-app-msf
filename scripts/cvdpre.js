...
var pushfunctionR5 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = '<tr><td>CVD Pre</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Success</td></tr>'
        ...
        warning: function (response) {
            ...
            var row = '<tr><td>CVD Pre</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Warning</td></tr>'
            $('.reporttable').append(row);
            htnDbActive = 0, htnDbTotal = 0, totalExit = 0, totalActive = 0, cerHtnDb12Total = 0, htnDbSeenTotal = 0;
        },
        error: function (response) {
            console.log("ERROR for OU = " + selectedou + " and Period = " + quarter);
            var row = '<tr><td>CVD Pre</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
            $('.reporttable').append(row);
            htnDbActive = 0, htnDbTotal = 0, totalExit = 0, totalActive = 0, cerHtnDb12Total = 0, htnDbSeenTotal = 0;
        }
    });
