...
var pushfunctionR1 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = "<tr onclick='displayValues(this,1);'><td>Active at end of RP</td><td>" + ounames[selectedou] + "</td><td>" + quarter + "</td><td>" + value + "</td><td>Success</td></tr>"
            $('.reporttable').append(row);
            activeAtTheEndPAtients = 0;
        },
        warning: function (response) {
            console.log("Warning! for OU = " + selectedou + " and Period = " + quarter);
            var row = '<tr onclick="displayValues(this,1);"><td>Active at end of RP</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>warning</td></tr>'
        ...
        error: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,1);"><td>Active at end of RP</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
