...
var pushfunctionR3 = function (value, quarter, selectedou) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,2);"><td>COPD and Asthama</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Success</td></tr>'
        ...
        warning: function (response) {
            ...
            var row = '<tr onclick="displayValues(this,2);"><td>COPD and Asthama</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Warning</td></tr>'
            $('.reporttable').append(row);
            copddenominator = 0, copdnumerator = 0, asthmanumerator = 0, asthmadenominator = 0;
        },
        error: function (response) {
            console.log("Error! pushed for OU = " + selectedou + " and Period = " + quarter + " value " + value);
            var row = '<tr onclick="displayValues(this,2);"><td>COPD and Asthama</td><td>' + ounames[selectedou] + '</td><td>' + quarter + '</td><td>' + value + '</td><td>Error</td></tr>'
            $('.reporttable').append(row);
            copddenominator = 0, copdnumerator = 0, asthmanumerator = 0, asthmadenominator = 0;
        }
    });
